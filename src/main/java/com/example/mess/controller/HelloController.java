...
/**
 * 问候控制器 - 提供简单的问候API，用于演示和测试
 * 
 * 所有接口公开访问（SecurityConfig中 /hello/** → permitAll）
 * 
 * API端点:
 * - GET  /hello          → 简单问候
 * - GET  /hello/advanced → 高级问候（支持版本号）
 * - POST /hello          → POST方式问候
 */
@RestController
...
public class HelloController {
    ...
    /** 高级问候，支持name和version参数。v2.0返回增强格式 */
    @GetMapping("/advanced")
